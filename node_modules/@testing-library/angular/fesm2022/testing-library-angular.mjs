...
async function render(sut, renderOptions = {}) {
    ...
    const { detectChangesOnRender = true, autoDetectChanges = true, declarations = [], imports = [], providers = [], schemas = [], queries, wrapper = WrapperComponent, componentProperties = {}, componentInputs = {}, componentOutputs = {}, inputs: newInputs = {}, on = {}, bindings = [], componentProviders = [], childComponentOverrides = [], componentImports, excludeComponentDeclaration = false, routes = [], removeAngularAttributes = false, defaultImports = [], initialRoute = '', deferBlockStates = undefined, deferBlockBehavior = undefined, configureTestBed = () => {
        /* noop*/
    ...
    const renderFixture = async (properties, inputs, outputs, subscribeTo) => {
        const createdFixture = await createComponent(componentContainer, bindings);
        ...
        if (bindings && bindings.length > 0) {
            ...
            if (Object.keys(inputs).length > 0) {
                console.warn('[@testing-library/angular]: You specified both bindings and traditional inputs. ' +
            ...
            if (Object.keys(subscribeTo).length > 0) {
                console.warn('[@testing-library/angular]: You specified both bindings and traditional output listeners. ' +
...
async function createComponent(component, bindings) {
...
class WrapperComponent {
    ...
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.1.7", type: WrapperComponent, isStandalone: false, selector: "atl-wrapper-component", ngImport: i0, template: '', isInline: true }); }
}
